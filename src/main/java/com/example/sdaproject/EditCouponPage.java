...
public class EditCouponPage {
    ...
    public void start(BorderPane primaryStage) {
        ...
        descriptionTextArea.setText(coupon.getDescription());
        ...
        startDatePicker.setValue(coupon.getStartDate().toLocalDate());
        ...
        endDatePicker.setValue(coupon.getEndDate().toLocalDate());
        ...
        discountComboBox.setValue(Double.toString(coupon.getDiscount()));
        ...
        Button createCouponButton = new Button("Update Coupon");
        ...
        minPriceSpinner.setText(Double.toString(coupon.getMinPrice()));
        ...
        maxDiscountSpinner.setText(Double.toString(coupon.getMaxPrice()));
        ...
        availableCouponsSpinner.setText(Integer.toString(coupon.getAvailableCoupons()));


        createCouponButton.setOnAction(e->{
            String response = SingletonTicketingSystemController.getInstance().editCoupon(coupon.getId(), descriptionTextArea.getText(), startDatePicker.getValue()==null?null: Date.valueOf(startDatePicker.getValue()), endDatePicker.getValue()==null?null:Date.valueOf(endDatePicker.getValue()), discountComboBox.getValue()==null?0:Double.valueOf(discountComboBox.getValue()), minPriceSpinner.getText() == null ? 0 : Double.valueOf(minPriceSpinner.getText()) , maxDiscountSpinner.getText() == null ? 0 : Double.valueOf(maxDiscountSpinner.getText()), Integer.valueOf(availableCouponsSpinner.getText()));
            errorLabel.setText(response);
            if (response.equals("Success")){
                Alert alert = new Alert(Alert.AlertType.INFORMATION);
                alert.setTitle("Success");
                alert.setHeaderText("Updated");
                alert.setContentText("Coupon Updated Successfully");
                alert.showAndWait();
