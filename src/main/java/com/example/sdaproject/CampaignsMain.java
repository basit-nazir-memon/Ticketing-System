...
public class CampaignsMain {
    ...
    public void start(BorderPane primaryStage) {
        ...
        Label couponsLabel = new Label("Campaign");
        ...
        Button createCouponButton = new Button("Create Campaign");
        ...
        Label errorLabel1 = new Label("Campaigns Created");
        ...
        Label errorLabel2 = new Label("Average Traffic");
        ...
        Label countLabel2 = new Label("70");
        ...
        Label errorLabel3 = new Label("Average Clicks");
        ...
        Label countLabel3 = new Label("50");
        ...
        Button cancelEditCouponButton = new Button("Cancel / Edit Campaign");
        ...
        Label couponsAvailableLabel = new Label("Campaigns Active");
